...
def main_qnrf(root_dir, save_dir):
    ...
    for phrase in ['Train','Test']:
        ...
        for img_path in tqdm(im_list):
            ...
            if imgName.replace('.jpg', '.npy') in os.listdir(sub_save_dir):
            ...
            # s_p = os.path.join(save_dir, phrase.lower(), 'imgs', imgName)
