...
def main_shab(root_dir, save_dir):
    os.makedirs(save_dir, exist_ok=True)
    for mod in ['train', 'test']:
        sub_save_dir = os.path.join(save_dir, mod, 'npys')
        os.makedirs(sub_save_dir, exist_ok=True)
        img_root = os.path.join(root_dir, mod + '_data', 'images')

        image_file_list = os.listdir(img_root)
...
if __name__ == "__main__":
    root_dir = r'/home/ff/myProject/KGT/myProjects/myDataset/shanghai/ShanghaiTech/part_B/train_data'
    save_dir = r'/home/ff/myProject/KGT/myProjects/myDataset/shanghai/ShanghaiTech/part_B/train_data/npys'

    main_shab(root_dir, save_dir)
