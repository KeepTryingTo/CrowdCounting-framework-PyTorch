...
def get_parser():
    ...
    parser.add_argument('--device-ids', type=str, default='0',help='GPU device,example "0,1,2"')
    ...
    parser.add_argument('--data-dir', type=str,
                        default=r'./CrowdCounting-framework-PyTorch/datasets/process_data/ucf_cc_50'
                        )
